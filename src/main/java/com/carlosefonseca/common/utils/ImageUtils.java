...
//            throw new IllegalStateException("setDensity not yet invoked. Display Metrics aren't yet available.");
    ...
    private static Bitmap tryPhotoFromFileOrAssets(File file, int widthDp, int heightDp) {
        Bitmap bitmap = null;
        if (file.exists()) {
